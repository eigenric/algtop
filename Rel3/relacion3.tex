...
\begin{sol}
No se trata de una esfera, pues entonces su característica sería 2.
Si fuera un $n$-toro, su característica $\chi = 2-2n = -2$ , luego
$2n = 4$ y $n = 2$, es decir que sería homeomorfa a la suma conexa de 2 toros.
Si fuera un $n$-plano proyectivo, su característica $\chi = 2-n = -2$, luego
$n = 4$, es decir que sería homeomorfa a un $4$-plano proyectivo.
\end{sol}
