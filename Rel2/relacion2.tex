...
(a) Si $\Pi_{1}\left(X, x_{0}\right)$ es finito, entonces el número de hojas es finito.\\
...
La idea intuitiva se basa en que si $\tilde{X}$ es compacto entonces la fibra de $x_0$ es finita.
Y por teoría de espacios recubridores, la fibra está en biyección con el levantamiento de un arco en su punto final.
Por tanto como la fibra era finita, el grupo fundamental de $X$ en $x_0$ también.
